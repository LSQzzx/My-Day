...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "myday";
    private static String CALENDARS_ACCOUNT_NAME = "myday@sp1der.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.sp1der.myday";
    private static String CALENDARS_DISPLAY_NAME = "MyDay账户";
